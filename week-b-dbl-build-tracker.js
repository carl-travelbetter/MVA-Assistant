console.log("Week B Dbl Build Tracker...");

let dblTimetable = [];
 fetch('week-b-dbl-build-timetable.json')
...
const PRIORITY_KEY = "b_dbl_build_priority";
...
function increasePriority() 
{
  ...
  if (priority > 2)
  {
    alert("All Double Build Tasks Done - Well Done Georgie");
