console.log("Week A Dbl Build Tracker...");

let dblTimetable = [];
 fetch('week-a-dbl-build-timetable.json')
...
const PRIORITY_KEY = "a_dbl_build_priority";
...
{
  console.log("Show/Hide DBL To Do List");
...
{
  console.log("Show/Hide DBL Done List");
