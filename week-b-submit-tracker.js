console.log("Week B Submit Tracker...");
...
function saveState() {
  ...
  localStorage.setItem(WEEK_B_SUBMIT_STORAGE_KEY, JSON.stringify(state));
}
...
function increasePriority() 
{
  ...
  localStorage.setItem(B_SLSUBMIT_PRIORITY_KEY, JSON.stringify(priority));
}
