console.log("Week B Dbl Develop Tracker...");

let dblTimetable = [];
 fetch('week-b-dbl-develop-timetable.json')
...
const PRIORITY_KEY = "b_dbl_develop_priority";
...
function increasePriority() 
{
  ...
  if (priority > 2)
  {
    alert("All Double Develop Tasks Done - Well Done Georgie");
   ...
   dblTimetable.forEach (item => 
    {
      if (item.priority === priority)
      {
        ...
        dueDay.textContent = "Due by "+lookupDay(item.day+2);
